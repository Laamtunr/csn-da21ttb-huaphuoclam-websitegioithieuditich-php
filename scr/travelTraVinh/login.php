...
<body style="  background-image: url('upload/black.jng'); ">
    ...
    <div style="width: 100%; margin-bottom: 30px; margin-top: 30px; ">
        <form class="from-dangky" method="post" action="#">
            <div style="text-align: center">  <H3 style="color: #f2f2f2;">Đăng nhập người dùng</H3></div>
            <div class="form-group">
                <label style="color: #f2f2f2;" for="">Email</label>
                <input type="text" class="form-control"  id="email" required="" placeholder="huaphuoclam120@gmail.com" name="email">
            </div>
            <div class="form-group">
