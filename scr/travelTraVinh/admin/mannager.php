<div class="Container">
    <div class="box-menu">
        <div class="administrator-logo">
            ...
            <a href="./"><p style="color: #FF7610; float: left">Quản lý</p></a>
        </div>
        ...
        <form method="get" action="#">
            ...
            <button class="btnkgvien">
                <div class="line-menu" style="color:#fff;">
                    ...
                    Địa điểm di tích lịch sử mới </div>
            </button>
        </form>
        ...
        <form method="get" action="#">
            ...
            <button class="btnkgvien">
                <div class="line-menu" style="color:#fff;">
                    ...
                    Quản lý địa điểm di tích lịch sử </div>
            </button>
        </form>
        <form method="get" action="#">
        ...
        <form method="get" action="#">
            <input name = "select" value="contactManagement" style="display: none">
            <button class="btnkgvien">
                <div class="line-menu" style="color:#fff;">
                    <i class="fas fa-comment-medical"></i>
                   Quản lí liên hệ người dùng</div>
            </button>
        </form>
        <form method="get" action="#">
